...
int main(void){
  ...
  param[3]=0.6055428;
                    /* Central Orbit:  Beta for 239MeV/u   */
  param[4]=1.007825/1;
                    /* Central Orbit: Charge to Mass Ratio */
  param[5]=10.;   /* Number of Turns                     */
  ...
  param[14]=0.582437534957;/* Mag. Sector: Field at Flat Top      */
  param[9]=1.57751; /* Multipl. Factor for w2 NOT USED     */
  param[10]=1.51769;/* Multipl. Factor for w1 NOT USED     */
  param[11]=1.019305;/* Multipl. Factor for Bending radius  */
  for(i=15;i<19;i++)
    param[i]=1.;    /* Reserved                            */
  param[19]=0.;     /* Debug: Parameters[2.] Print[1.]     */
		    /*        No Print  [0.]               */
  
  // Standard Tof in use
  dtime0 =param[5]*param[2]/param[3]/2.99792458e8;
  dtime0*=(1.-5.004408e-05);  /* Fine Adjust */
