...
c*** Parameters ***c
      val(27,naok) = val(28,naok) - 747.822 ! TOF_R3 - (TOFs0kc+TOFkcelc by MOCADI) for 36Ar
      val(29,naok) = val(28,naok) - 763.085 ! TOF_R3 - (TOFs0kc+TOFkcelc by MOCADI) for 35Cl
...
c      tof0 = 716047.0 ! [ns] Mean of TOF_S0ELC for 36Ar
c      tof1 = 716147.0 ! [ns] Mean of TOF_S0ELC for 35Cl
c      t0 = 378.32 ! [ns/turn] ]Revolution time of 36Ar which was determined by MCP
c      t1 = 386.33 ! [ns/turn] ]Revolution time of 35Cl which was determined by MCP
c
...
c      t00 = (716047.-747.822)/1891 ! for 36Ar only R3 by MOCADI
c      t00 = (716047.-643.880)/1891 ! for 36Ar only R3 by N*Tmcp
c      t01 = val(33,naok) ! for 35Cl only R3
      t00 = (716047. - 39 * 378.32)   ! Changed TOF of 36Ar, path length same as 35Cl
      t01 = val(28,naok)        ! for 35Cl
      val(34,naok) = t01 / t00 
c
c TOF calibration using 38K,37Ar,36Cl in run0128
c      bet01 = -0.0009665381*S0TOF_FH10 + 1.1844553211 ! Brho-value by using Atomic mass in precise
c      bet01 = -0.000967*S0TOF_FH10 + 1.184455 ! Brho-value by using Atomic mass
c      bet01 = -0.0009668413*S0TOF_FH10 + 1.1847674410 ! Brho-value by using Ion mass in precise
c      bet01 = -0.000967*S0TOF_FH10 + 1.184767 ! Brho-value by using Ion mass
c      bet01 = bet01 * 0.9989 ! after for S0-pla 0.100mmt for 35Cl
      bet01 = 0.5327622 / val(34,naok)
...
ccc mass excess of 35Cl [keV]
      ...
      val(41,naok) = 931494.013597959*(val(43,naok)-35)
ccccccc
ccccccc
...
c      t10 = (716147.-763.085)/1852 ! for 35Cl only R3 by MOCADI
c      t10 = (716147.-663.840)/1852 ! for 35Cl only R3 by N*Tmcp
c      t11 = val(32,naok) ! for 36Ar only R3
      t10 = (716147. + 39 * 386.33)   ! Changed TOF of 35Cl, path length same as 36Ar
      t11 = val(28,naok)       ! for 36Ar
      val(11,naok) = t11 / t10 
c
c TOF calibration using 38K,37Ar,36Cl in run0128
c      bet11 = -0.0009665381*S0TOF_FH10 + 1.1844553211 ! Brho-value by using Atomic mass in precise
c      bet11 = -0.000967*S0TOF_FH10 + 1.184455 ! Brho-value by using Atomic mass
c      bet11 = -0.0009668413*S0TOF_FH10 + 1.1847674410 ! Brho-value by using Ion mass in precise
c      bet11 = -0.000967*S0TOF_FH10 + 1.184767 ! Brho-value by using Ion mass
c      bet11 = bet11 * 0.9989 ! after for S0-pla 0.100mmt for 36Ar
      bet11 = 0.5215428 / val(11,naok)
...
ccc mass excess of 36Ar [keV]
      ...
      val(42,naok) = 931494.013597959*(val(44,naok)-36)
