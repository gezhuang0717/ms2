...
ccc local variables ccc                                                                  
      ...
      real moq_0,moq_1,T_0,T_1,tof_0,N_turn_raw,N_turn,dpop,Tsum_F2
      real TOF_23,tof_offset_23
...
c      val(26,naok) = ilc1x ! ILC1 PPAC X
c      val(28,naok) = ilc1y ! ILC1 PPAC Y
...
c        amu = mu * pow(c,2) / e * 1.e-6;  
       ...
       lring = 60.35  ! curcumference of ring [m]
...
c      T_0 = 372. ! 38K [ns]
       ...
       tof_offset_23 = 0.0 ! TOF offset F2 to F3
       tof_offset_3S = 0.0 ! TOF offset F3 to S0
       tof_offset_R3 = 0.0 ! TOF offset S0 to ELC
...
cc      aoq_R3 = clight*brho_R3*dp/amu/beta/gamma
       ...
       N_turn_raw = TOF_R3*beta*clight*1.e-3/TOF_3S ! ~ the number of turn
       N_turn = TOF_R3/TOF_3S ! proportional to the number of turn

       T_1 = TOF_R3/N_turn_raw
...
c put ito vals
       ...
       val(5,naok) = TOF_R3*1.e-3 !micro second
