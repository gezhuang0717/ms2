...
cccccccccccccc
      ...
      val(29,naok) = val(22,naok) - F3Tavr
      S0TOF_FH10 = val(29,naok)
...
c      val(2,naok) = ELC_UT - 700000. ! TU in nsec -700us
c      val(3,naok) = ELC_DT - 700000.! TD in nsec -700us
ccc mod. by yoshi 2016/1/15 for deducing moq
...
c S0TOF_R3 signal comes to R3 console after 511ns compare with ELCTOF.
      val(24,naok) = val(12,naok) - S0TOF_R3 + 511. ! Ring TOF use R3 data
      val(26,naok) = val(22,naok) + 0.0000 ! TOF_S0ELC using FH10 data
      val(28,naok) = val(24,naok) + 0.0000 ! TOF_S0ELC using R3 data
      val(55,naok) = val(24,naok) - 716000 ! TOF_S0ELC using R3 data -716us
    
ccc add by yoshi 2016/1/15~
c*** Parameters ***c
      val(27,naok) = val(28,naok) - 747.548 ! TOF_R3 - (TOFs0kc+TOFkcelc by MOCADI) for 36Ar
      val(29,naok) = val(28,naok) - 763.630 ! TOF_R3 - (TOFs0kc+TOFkcelc by MOCADI) for 35Cl
c      val(27,naok) = val(28,naok) - 643.880 ! TOF_R3 - (TOFs0kc+TOFkcelc by N*Tmcp) for 36Ar
c      val(29,naok) = val(28,naok) - 663.840 ! TOF_R3 - (TOFs0kc+TOFkcelc by N*Tmcp) for 35Cl
c
c      val(30,naok) = val(28,naok) / 1891. ! T0_R3 for 36Ar
c      val(31,naok) = val(28,naok) / 1852. ! T1_R3 for 35Cl
      val(32,naok) = val(27,naok) / 1891. ! T0_R3 after sub. for 36Ar
      val(33,naok) = val(29,naok) / 1852. ! T1_R3 after sub. for 35Cl
c
c      m0q = 1.998197 ! m/q of 36Ar from AME (Atomic mass)
c      m1q = 2.056991 ! m/q of 35Cl from AME (Atomic mass)
      m0q = 1.997649 ! m/q of 36Ar from AME (Ion mass)
      m1q = 2.056444 ! m/q of 35Cl from AME (Ion mass)
      m2q = 1.997829 ! m/q of 38K from AME (Ion mass)
c      tn0 = 1891 ! Turn number of 36Ar
c      tn1 = 1852 ! Turn number of 35Cl
c      dtn = tn0 - tn1 ! Difference of turn number between 36Ar and 35Cl
c      tof0 = 716042.8326 ! [ns] Mean of TOF_S0ELC for 36Ar
c      tof1 = 716143.8870 ! [ns] Mean of TOF_S0ELC for 35Cl
c      t0 = 378.317 ! [ns/turn] ]Revolution time of 36Ar which was determined by MCP
c      t1 = 386.332 ! [ns/turn] ]Revolution time of 35Cl which was determined by MCP
c
c Beta correction using Brho @f6x
       dx = 97.09          ! Dispersion @BigRIPS-F6  rms=1.95 97.09+1.95=99.04
       brhoave1 = 3.8891   ! rms=0.0017,,, Brho@D5=3.8859, BrhoMax=3.8897, BrhoMin=3.8853
       brhoave2 = 3.8874   ! Brho average @BigRIPS-F3 - S0
       brho = brhoave2 + brhoave2*(0.01*f6x/dx)
       val(45,naok) = brho
       brho = brho*brho
       cc = 299.792458*299.792458
       mu = 931.4940136*931.4940136
       bet36ar = sqrt((brho*cc)/(m0q*m0q*mu+brho*cc))
       val(46,naok) = bet36ar
       bet35cl = sqrt((brho*cc)/(m1q*m1q*mu+brho*cc))
       val(47,naok) = bet35cl
       bet38k = sqrt((brho*cc)/(m2q*m2q*mu+brho*cc))
       val(52,naok) = bet38k
c
c
c*** m1/q of 35Cl with 36Ar reference ***c 
c
c      t00 = 716034./1891 ! for 36Ar S0 to ELC
c      t00 = 716047./1891 ! for 36Ar S0 to ELC
c      t00 = 716060./1891 ! for 36Ar S0 to ELC
c      t01 = val(31,naok) ! for 35Cl S0 to ELC
c      t00 = (716047.-747.548)/1891 ! for 36Ar only R3 by MOCADI
c      t00 = (716047.-643.880)/1891 ! for  36Ar only R3 by N*Tmcp
c      t01 = val(33,naok) ! for 35Cl only R3
      t00 = (716042.8326 - 39 * 378.317)   ! Changed TOF of 36Ar, path length same as 35Cl
c fastest point of TOF0
c      t00 = (716034.85 - 39 * 378.317)   ! Changed TOF of 36Ar, path length same as 35Cl
c uncertainty of MCP
c      t00 = (716042.8326 - 39 * 378.327)   ! Changed TOF of 36Ar, path length same as 35Cl
c uncertainty of TOF0
c      t00 = t00 + 6.89814
      t01 = val(28,naok)        ! for 35Cl
      val(34,naok) = t01 / t00 
c
c TOF calibration using 38K,37Ar,36Cl in run0128
      bet01 = 281.913/(S0TOF_FH10 - 122.456) ! Brho-value by using Ion mass  beta=b/(TOF-a)
c uncertainty of TOFcalib fitting for 38K,37Ar,36Cl
c      bet01 = 282.66/(S0TOF_FH10 - 121.286) ! Brho-value by using Ion mass  beta=b/(TOF-a)
c uncertainty of Brho f3-s0 for 3.8891Tm
c      bet01 = 282.07/(S0TOF_FH10 - 122.328) ! Brho-value by using Ion mass  beta=b/(TOF-a)
cc      bet01 = 282.15/(S0TOF_FH10 - 121.99) ! Ozawa-san
      val(48,naok) = bet01/bet35cl*(1 - 0.15984e-4*f6x)
      val(50,naok) = bet01/bet35cl
      bet01 = bet01*(1 - 0.15078e-4*f6x) ! using correction param. of 36Ar
c uncertainty of TOFcalib fitting for 38K,37Ar,36Cl
c      bet01 = bet01*(1 - 0.21526e-4*f6x) ! using correction param. of 36Ar
c uncertainty of Brho f3-s0 for 3.8891Tm
c      bet01 = bet01*(1 - 0.14770e-4*f6x) ! using correction param. of 36Ar
c uncertainty of Dispersion @ f6  for 99.04 mm/%
c      bet01 = bet01*(1 - 0.16787e-4*f6x) ! using correction param. of 36Ar
cc      bet01 = bet01*(1 - 1.5814e-5*f6x) ! Ozawa-san
      bet01 = bet01 * 0.99767 ! after for FH10-ppacx2 + S0-pla 0.100mmt for 35Cl
c      bet01 = bet01 * 0.99893 ! after for S0-pla 0.100mmt for 35Cl
cc      bet01 = bet01 * 0.99892 ! Ozawa-san
c uncertainty of S0-pla for 0.114mmt (1-sigma of +25%)
c      bet01 = bet01 * 0.99877 ! after for S0-pla 0.114mmt for 35Cl
c      bet01 = bet35cl * 0.99893 ! after for S0-pla 0.100mmt for 35Cl
c      bet01 = 0.5327622 / val(34,naok)
      val(39,naok) = bet01     ! beta1 for 35Cl
      bet01 = bet01 * bet01       ! beta1*beta1 for 35Cl
c      bet01 = 0.52127 * 0.52127       ! beta1*beta1 for 35Cl
c
      val(35,naok) = val(34,naok) * val(34,naok)
      val(36,naok) = val(35,naok) * bet01
      val(37,naok) = m0q * val(34,naok)
      val(38,naok) = val(37,naok)*sqrt((1-bet01)/(1-val(36,naok)))
      val(40,naok) = val(31,naok)*sqrt((1-bet01)/(1-val(36,naok)))
ccc TOF1coll
      val(56,naok) = val(28,naok)*sqrt((1-bet01)/(1-val(36,naok)))
ccc mass excess of 35Cl [keV]
      val(43,naok) = val(38,naok)*17.
      bez1 = 1.353022e-5 
      me = 0.510998902
      val(41,naok) = 931.494013597959*(val(43,naok)-35.-bez1)+17.*me
      val(41,naok) = val(41,naok)/0.001
ccccccc
ccccccc
c*** m1/q for 36Ar with 35Cl reference ***c

c      t10 = 716134./1852 ! for 35Cl S0 to ELC
c      t10 = 716147./1852 ! for 35Cl S0 to ELC
c      t10 = 716160./1852 ! for 35Cl S0 to ELC
c      t11 = val(30,naok) ! for 36Ar S0 to ELC
c      t10 = (716147.-763.630)/1852 ! for 35Cl only R3 by MOCADI
c      t10 = (716147.-663.840)/1852 ! for 35Cl only R3 by N*Tmcp
c      t11 = val(32,naok) ! for 36Ar only R3
      t10 = (716143.8870 + 39 * 386.332)   ! Changed TOF of 35Cl, path length same as 36Ar
c Fastest point of TOF0
c      t10 = (716134.1 + 39 * 386.332)   ! Changed TOF of 35Cl, path length same as 36Ar
c uncertainty of MCP
c      t10 = (716143.8870 + 39 * 386.388)   ! Changed TOF of 35Cl, path length same as 36Ar
c uncertainty of TOF0
c      t10 = t10 + 6.15388
      t11 = val(28,naok)       ! for 36Ar
      val(11,naok) = t11 / t10 
c
c TOF calibration using 38K,37Ar,36Cl in run0128
      bet11 = 281.913/(S0TOF_FH10 - 122.456) ! Brho-value by using Ion mass  beta=b/(TOF-a)
c uncertainty of TOFcalib fitting for 38K,37Ar,36Cl
c      bet11 = 282.66/(S0TOF_FH10 - 121.286) ! Brho-value by using Ion mass  beta=b/(TOF-a)
c uncertainty of Brho f3-s0 for 3.8891Tm
c      bet11 = 282.07/(S0TOF_FH10 - 122.328) ! Brho-value by using Ion mass  beta=b/(TOF-a)
      val(49,naok) = bet11/bet36ar*(1 - 0.15078e-4*f6x)
      val(51,naok) = bet11/bet36ar
      bet11 = bet11*(1 - 0.15984e-4*f6x) ! using correction param. of 35Cl
c uncertainty of TOFcalib fitting for 38K,37Ar,36Cl
c      bet11 = bet11*(1 - 0.22688e-4*f6x) ! using correction param. of 35Cl
c uncertainty of Brho f3-s0 for 3.8891Tm
c      bet11 = bet11*(1 - 0.17993e-4*f6x) ! using correction param. of 35Cl
c uncertainty of Dispersion @ f6  for 99.04 mm/%
c      bet11 = bet11*(1 - 0.17152e-4*f6x) ! using correction param. of 35Cl
      bet11 = bet11 * 0.99770 ! after for FH10-ppacx2 + S0-pla 0.100mmt for 36Ar
c      bet11 = bet11 * 0.99893 ! after for S0-pla 0.100mmt for 36Ar
c uncertainty of S0-pla for 0.114mmt (1-sigma of +25%)
c      bet11 = bet11 * 0.99878 ! after for S0-pla 0.114mmt for 36Ar
c      bet11 = bet36ar * 0.99893 ! after for S0-pla 0.100mmt for 36Ar
c      bet11 = 0.5215428 / val(11,naok)
      val(13,naok) = bet11      ! beta1 for 36Ar
      bet11 = bet11 * bet11       ! beta1*beta1 for 36Ar
c      bet11 = 0.53240 * 0.53240       ! beta1*beta1 for 36Ar
c
ccc Beta for 38K
      bet22 = 279.408/(S0TOF_FH10 - 127.136)
      bet22 = bet22*(1 - 0.95e-5*f6x)
      val(54,naok) = bet22
      val(53,naok) = bet22/bet38k      
c
      val(15,naok) = val(11,naok) * val(11,naok)
      val(17,naok) = val(15,naok) * bet11
      val(18,naok) = m1q * val(11,naok)
      val(19,naok) = val(18,naok)*sqrt((1-bet11)/(1-val(17,naok)))
ccc TOF1coll
      val(57,naok) = val(28,naok)*sqrt((1-bet11)/(1-val(17,naok)))
ccc mass excess of 36Ar [keV]
      bez2 = 1.551212e-5
      val(44,naok) = val(19,naok)*18.
      val(42,naok) = 931.494013597959*(val(44,naok)-36.-bez2)+18.*me
      val(42,naok) = val(42,naok)/0.001
